...
NMilitary = {
	...
	MERCENARY_MAINTENANCE_FACTOR = 0.75,				-- Maintenance factor for NORMAL mercenary units v12c +25% v15 now +50% of 0.5
	MERCENARY_VASSAL_MAINTENANCE_FACTOR = 1,		-- Maintenance factor for VASSALIZED mercenary units v12c +25% v15 now 100% of 0.5
	MERCENARY_HIRE_COST_FACTOR = 0.16,				-- Hire cost factor for mercenary units v15 now 20% cheaper than 0.2
