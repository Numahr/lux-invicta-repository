...
NCharacter = {
	...
	EARLY_PORTRAIT_AND_UNIT_BEFORE_YEAR = 9998,		-- Before this date, early versions of Units and Portraits will be used if available
...
NFrontend = 
{
	...
	CAMERA_END_X = 875.0,				-- Move to position in main menu v12 790 default now 1225 v15
	...
	TIME_FROZEN = 2.5,  				-- Time before initial animation starts (some delay here so it should NOT be 0, then the animation starts before you can see it)
	TIME_UNTIL_ROTATE = 5, 			-- Time when rotation start (from beginning of time)
	CAMERA_SPEED_START = 0.02,  			-- Initial animation speed v12 previously 0.04?
	CAMERA_SPEED_ROTATE = 0.02,			-- Rotation speed
	GUI_MOVE_SPEED = 200,				-- How fast sliding gui objects move ( pixels/s ) v12 300 default (stuff like the new game menu's) v15 225 (no real reason)
	
	FADE_IN_DONE_TIME = 2, --v12  2.2 default
	GUI_START_MOVE_TIME = 2.5,
	CAMERA_START_MOVE_TIME = 2.5, --v12 3.0 default
	
	CAMERA_SPEED_IN_MENUS = 0.02, --v12 0.4 default - the sweeping speed
	
	FRONTEND_POS_X = 875.0, -- v12 790 default now 1425
	FRONTEND_POS_Y = 115.0, -- v12 500 default now 115
	FRONTEND_POS_Z = 1900.0, -- v12 600 default now 750
